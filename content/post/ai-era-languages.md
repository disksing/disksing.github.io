...
更麻烦的是各种"魔法"。Ruby 的元编程、Python 的各种 dunder 方法、运算符重载，这些东西人类觉得很酷，但 AI 容易搞混。我见过 AI 把 `__getitem__` 和 `__getattr__` 搞混的，也见过它自作聪明地用元编程结果出 bug 的。
